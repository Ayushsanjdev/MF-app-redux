...
export class TodoList extends React.Component {
    constructor(props) {
        ...
        this.globalStore.RegisterStore("ProfileApp", this.store, [GlobalStore.AllowAll]);
        
        try {
            this.globalStore.SubscribeToPartnerState("ProfileApp", "LoginApp", this.counterChanged)
        }
        catch (error) { 
            //Since
        }
        this.globalStore.Subscribe("ProfileApp", this.stateChanged);
    }

    addTodo(description) {
        this.globalStore.DispatchAction("ProfileApp", AddTodo(description));
    }

    removeTodo(todoId) {
        this.globalStore.DispatchAction("ProfileApp", RemoveTodo(todoId));
    }
